...
function Profile() {
  ...
  return loadingStatus ? (
    ...
    <div className="flex-grow border-l border-r border-gray-700 max-w-2xl w-2/3 text-white">
     {isEditOpen && ( <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => setUpdateDetails({ ...updateDetails, bio: e.target.value })}
      ...
      <div className="mt-20 px-4">
        <div className="flex justify-end mb-4">
          <button onClick={() => setIsEditOpen(true)} className="px-4 py-2 border border-gray-700 rounded-full font-bold hover:bg-gray-900">
            Edit profile
          </button>
        </div>
